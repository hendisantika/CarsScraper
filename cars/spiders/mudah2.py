...
class Tes1(scrapy.Spider):
    name = "mudah"
    start_urls = [
        'http://www.mudah.my/malaysia/cars-for-sale',
    ]
    ...
    def parse(self, response):
        ...
        # process next page
        next_page_url = response.xpath('//*[@id="list_ads_container"]/div[1]/div[3]/span[2]/span/a/@href').extract_first() #YANG INI UDAH OK NEXT PAGE NYA NICH
